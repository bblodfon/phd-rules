...
You should ask for proper advice and practical help during the PhD period.
...
It is the importance of the writing task that calls for such careful preparedness.
:::
...
The thesis content is split into several chapters, each with notes and ideas corresponding to paragraphs that you need to write.
Therefore the problem is split into smaller subtasks, the writing and the subsequent rewriting of paragraphs.
Completing the subtasks, which is synonymous to writing the respective paragraphs, will solve the original problem.
...
The idea is that by making the subtasks small enough, you can easily finish one subtask within a day's work and achieve thus your daily writing goal.
The singular idea inherent in this principle is fundamental to the rules' proposed success: one paragraph per day, one paper per day, always one thing at a time.
