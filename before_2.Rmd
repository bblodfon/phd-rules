...
:::{.indent}
Here's another piece of advice if you are close to the end of your PhD (let's say around half to one year before submission) and you have a lot of papers in your  to-read list: first, **focus on abstracts** and second, **read review papers**.
...
Review papers will point you to other important papers that you may have missed.
...
The simplest way to start remembering is by repeating in your mind keywords and sentences that you've read (or your own variations of them) and enter a process of internal conversation with yourself.
...
It might be of help to think of this whole mental activity in a visual manner: attaching refined pieces of information at appropriate branches in your knowledge tree!
:::

:::{.indent}
In the end, using the aforementioned remembering technique, you will **build your own personalized tree of knowledge**, fine-tuned to the subject you will be writing about in your PhD thesis.
Moreover, the tree's size as well as depth will be considerably increased.
Note that any other memory and knowledge visualization technique might work as well.
...
:::{.quote}
Read mostly abstracts and reviews during the last months of your PhD.
:::
