...
I call this principle "*basic cable*", and I view it as equally important as the principle of diversity is with regard to the choice of work environments (see [Rule 5](#rule5)).
...
To address this, Duolingo suggests that you do one single session per day, which can take up to 15 minutes on average.
...
Creating the first version of a paragraph is associated with the initial PhD story structure that we discussed in [Rule 3](#rule3).
...
Here is what you need to do: let your thoughts about an idea *flow* from mind to pen (or keyboard).
...
The diverse environments might also help (see [Rule 5](#rule5)).
This process of text generation is all about *having a continuous flow*.
...
Therefore, **your role has to change from a text producer to that of an editor**.
...
**Try to split them into smaller sentences** to achieve a higher level of brevity and clarity.
...
:::{.quote}
Aim to write at least one new paragraph per day and if circumstances allow, do some rewriting as well.
:::
